...
export const ResetPasswordLayout = (props: IResetPasswordProps) => (
    <React.Fragment>
            ...
            <div className="authentication-inner py-5">
                ...
                <form className="card">
                    <div className="p-4 p-sm-5">
                        ...
                        <h5 className="text-center text-muted font-weight-normal mb-4">Reset Your Password</h5>
                        ...
                        <button className="btn btn-primary btn-block" data-toggle="collapse" disabled={props.disabled} onClick={props.onSubmit}> Send password reset email</button>
                    </div>
                </form>
            </div>
        </div>
