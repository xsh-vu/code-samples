...
namespace Web.Controllers.Api.App
{
    [RoutePrefix("api/app/apptokentypes")]
    public class AppTokenTypeController : ApiController
    {
    
        private IAppTokenType_Service _attService;
        private IAppLogService _appLogService;
        private IUserService _userService;

        public AppTokenTypeController(IAppTokenType_Service attService, IAppLogService appLogService, IUserService userService)
        {
        ...
        [Route(), HttpPost]
        public IHttpActionResult Post(AppTokenType_AddRequest model)
        {
            try
            {
        ...
        public IHttpActionResult Put(AppTokenType_UpdateRequest model)
        {
            try
            {
